...
var Portal = React15.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React15.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var Paper = React20.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(PaperRoot, {
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FSYV6SVC.js.map
